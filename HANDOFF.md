...
| Widgets (Home Screen, Lock Screen, StandBy, iPad) | ✅ Code complete — small, medium, large, extra-large, circular, rectangular, and inline families; Lock Screen gallery/StandBy placement still needs manual QA |
...
| Live Activities | ✅ Code complete — local-only Lock Screen + Dynamic Island UI for one sleep away and timed events in their final 24 hours |
| Yearly repeat | ✅ Done, unit-tested — opt-in automatic rollover; Feb 29 becomes Feb 28 in non-leap years |
| Arrival celebration | ✅ Done — confetti + haptic, with a larger regular-width presentation |
...
- Lock Screen widget gallery discovery and StandBy rendering for circular/rectangular/inline families.
...
- Live Activity and Dynamic Island lifecycle on a supported physical device.
