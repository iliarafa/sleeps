...
_Last verified: 2026-07-15 — 43 unit tests passing, builds clean, website live._
...
CountdownKit/       Swift package: model, date math, text, notification planner, theme, 24 icons
  ...
  Tests/CountdownKitTests/         43 tests (date math, text, planner, icon mapping, countdown phase)
...
cd CountdownKit && swift test      # 43 unit tests
